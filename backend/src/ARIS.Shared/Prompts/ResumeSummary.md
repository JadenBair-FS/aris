...
2. Write in third person only. Do not use first-person pronouns (I, my, me, we, our). Use direct statements: "Brings 5 years of...", "Experienced in...", "Demonstrated expertise in..." — never "I have...", "My background...".
...
5. Do not mention any skill listed under HARD GAPS (T5). This is an absolute prohibition.
6. Do not include the candidate's name.
7. No em-dashes, no hyphens used as dashes, no semicolons, no parentheses.
8. Plain text only — no markdown, no asterisks, no bold, no italic, no bullet points, no headers, no special characters used for formatting.
