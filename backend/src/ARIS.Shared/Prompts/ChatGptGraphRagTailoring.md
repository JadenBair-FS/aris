...
════════════════════════════════════════
TASK:
Rewrite this resume to better align with the job description. Use the graph context above to understand which skills the candidate can legitimately emphasize and which are hard gaps to avoid.
...
2. Do not mention or imply any skill listed as a HARD GAP (T5) in the graph context.
3. Write in third person. Do not use first-person pronouns (I, my, me, we, our). Use direct statements: "Developed...", "Led...", "Delivered...".
4. Plain text only. No markdown, no asterisks, no bold, no bullet symbols, no headers, no special characters used for formatting.
